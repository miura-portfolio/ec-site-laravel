{{-- ファイル: products/list_view.blade.php
 目的 : 商品一覧＋検索フォーム
 依存 : route('product.list'), route('product.detail'), route('purchase.form') --}}
...
<div class="container container-narrow">
    ...
    @if (session('success'))
        <div class="flash-message" role="status" aria-live="polite">{{ session('success') }}</div>
    @endif
