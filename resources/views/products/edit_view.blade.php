{{-- ファイル: products/edit_view.blade.php
 目的 : 出品商品の編集（画像削除/差し替え対応）
 依存 : route('product.update'), route('product.ownerDetail') --}}
...
<div class="container container-narrow">
    ...
    <form method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <input type="text" id="name" name="name" value="{{ old('name', $product->product_name) }}" required>
        </div>
        ...
        <div class="form-row">
            ...
            <input type="text" id="company_name" name="company_name" value="{{ old('company_name', $product->company->company_name ?? '') }}">
        </div>
        ...
        <div class="form-row image-field">
            ...
            <div class="file-row">
                ...
                <button type="button" class="btn btn-secondary btn-compact js-clear-file" data-target="#image">選択をクリア</button>
            </div>
        </div>
